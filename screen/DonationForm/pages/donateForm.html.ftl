                ...
                <legend>Card Information</legend>
                    <div id="card-one-liner" class="stripe-input-wrapper">
                        <span class="InputContainer" data-max="4242 4242 4242 4242 4242">
                            ...
                            <span class="InputContainer" data-max="4242 4242 4242 4242 4242">
                                <input class="InputElement is-empty Input Input--empty" autocomplete="cc-number" autocorrect="off" spellcheck="false" name="expireMonth" inputmode="numeric" aria-label="Credit or debit card number" placeholder="MM" aria-placeholder="Card number" aria-invalid="false" value="">
                                  <span class="InputContainer" data-max="4242 4242 4242 4242 4242">
                                <input class="InputElement is-empty Input Input--empty" autocomplete="cc-number" autocorrect="off" spellcheck="false" name="expireYear" inputmode="numeric" aria-label="Credit or debit card number" placeholder="YYYY" aria-placeholder="Card number" aria-invalid="false" value="">
